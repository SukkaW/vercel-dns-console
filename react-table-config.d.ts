...
declare module 'react-table' {
  ...
  export interface Hooks<D extends Record<string, unknown> = Record<string, unknown>> extends
    //    UseExpandedHooks<D>,
    //   UseGroupByHooks<D>,
    UseRowSelectHooks<D>,
    UseSortByHooks<D> { }
  ...
  export interface Row<D extends Record<string, unknown> = Record<string, unknown>> extends
